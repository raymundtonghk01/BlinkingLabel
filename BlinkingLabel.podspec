...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/raymundtong@hk01.com/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'raymundtong@hk01.com' => 'raymundtong@hk01.com' }
  s.source           = { :git => 'https://github.com/raymundtong@hk01.com/BlinkingLabel.git', :tag => s.version.to_s }
